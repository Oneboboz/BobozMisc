#!/usr/bin/env python3
"""
Convert a TinyTalk/TinyStories-Instruct GPT-Neo checkpoint for the ESP32-S3 essay runtime into:
...
def main():
    ...
    ap.add_argument("--repo-id", default=None,
                    help="Hugging Face repo id; overrides --model (8M defaults to TheREZOR/TinyTalk-2)")
    ...
    if args.model_dir:
        ...
        snap = Path(snapshot_download(repo_id=repo_id, cache_dir=args.cache,
